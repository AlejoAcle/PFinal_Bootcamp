            ...
            <p>¿Que día quieres entrenar?</p>
            {
                ...
                clases.map(parametro => {
                    ...
                    return (
                        ...
                        <div key={parametro._id} className="container_exercices1">
                            <Link  className="classes" to={`/timetables/${parametro._id}`}>
                            <button className="exercices">{correctDate}</button></Link> 
                        </div>
                    )
                })
            }
